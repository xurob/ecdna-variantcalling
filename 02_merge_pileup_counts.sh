...
cat ${dir}/*.filteredreadslog.txt > "${directoryout}/${samplename}_all.filteredreadslog.txt"
cat ${directory}/*.coverage.txt > "${directoryout}/${samplename}_all.coverage.txt"
cat ${directory}/*.depthTable.txt > "${directoryout}/${samplename}_all.depthTable.txt"
